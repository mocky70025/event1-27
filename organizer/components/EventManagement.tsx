      ...
      {!showEventForm && (
        <nav
          style={{
            ...
            borderRadius: '28px',
            boxShadow: '0 18px 48px rgba(249,115,22,0.14)',
            display: 'flex',
            alignItems: 'center',
            ...
            return (
              <button
                ...
                style={{
                  ...
                  border: isActive ? '1px solid rgba(249,115,22,0.40)' : '1px solid transparent',
                  borderRadius: '16px',
                  boxShadow: isActive ? '0 12px 26px rgba(249,115,22,0.18)' : 'none',
                  cursor: 'pointer',
                  padding: '12px 14px'
                }}
              >
                <div
                  style={{
                    width: '36px',
                    height: '36px',
                    background: isActive ? '#FFF4E9' : '#F6F8FB',
                    borderRadius: '10px',
                    border: isActive ? '1px solid #F97316' : '1px solid #E5E7EB',
                    boxShadow: isActive ? '0 8px 16px rgba(249,115,22,0.14)' : 'none',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
